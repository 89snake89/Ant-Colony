...
public abstract class AntColony implements Observer
{
    ...
    public AntColony(AntGrid graph, int nAnts, int nIterations)
    {
        m_graph = graph;
        m_nAnts = nAnts;
    ...
    public synchronized void start()
    {
        ...
        try
        {
            m_outs = new PrintStream(new FileOutputStream("E:\\" + m_nID + "_" + m_graph.nodes() + "x" + m_ants.length + "x" + m_nIterations + "_colony.txt"));
        }
        catch(Exception ex)
        {
            ex.printStackTrace();
    ...
    protected abstract Ant[] createAnts(AntGrid graph, int ants);
